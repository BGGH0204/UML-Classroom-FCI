...
|IA|O drone identifica a tarefa definida para a missão. 
A IA inicia a execução da tarefa. A tarefa é monitorada até sua conclusão. Os dados sao registrados e armazenados (caso tenha dados)|
